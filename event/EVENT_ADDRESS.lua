...
EVENT_ADDRESS.LISTENER_MAP = {
	...
	[EVENT_LISTENER.GAME_STATE_MANAGER] = {
		...
		[EVENT_DISPATCHER.PLAYER_INPUT] = {3},
	},
...
EVENT_ADDRESS.SYSTEM_DISPATCHER_MAP = {
	...
	[SYSTEM_ID.FILE_HANDLING] = EVENT_DISPATCHER.FILE_HANDLING,
}
...
EVENT_ADDRESS.SYSTEM_LISTENER_INDEX_MAP = {
	...
	[SYSTEM_ID.FILE_HANDLING] = {
		[EVENT_ADDRESS.SYSTEM_LISTENER_INDEX[SYSTEM_ID.FILE_HANDLING].MAIN] = EVENT_LISTENER.FILE_HANDLING
	},
}
